import 'package:fitnc_user/page/exercice/exercise-detail.notifier.dart';
                          ...
                          children: <Widget>[
                                            ...
                                            if (controller.exercise.uid != null)
                                              TextButton.icon(
                                                ...
                                                onPressed: () => Navigator.of(context).push(
                                                  MaterialPageRoute(
                                                    builder: (context) =>
                                                        StatExercisePage(exercice: controller.exercise),
                                                  ),
                                                ),
                                              ),
                                            Padding(
                                              ...
                                              child: TextFormField(
                                                ...
                                                style: GoogleFonts.antonio(fontSize: 15),
                                                readOnly: isReadOnly,
                            ...
                            DropdownButtonFormField<TypeExercise>(
                              ...
                              onChanged: isReadOnly
                                  ? null
                                  : (TypeExercise? onChangedValue) => controller.exercise.typeExercise = onChangedValue,
                              value: controller.exercise.typeExercise,
                              items: TypeExercise.values
                                  .map(
                                    (e) => DropdownMenuItem(
                                      value: e,
                                      child: Text(
