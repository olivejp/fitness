...
import 'package:fitnc_user/service/abstract-crud.service.dart';
import 'package:fitnc_user/mixin/fitness-storage.mixin.dart';
import 'package:fitnc_user/service/firebase-query-condition.dart';
import 'package:fitnc_user/service/i-from-json.dart';
...
abstract class AbstractFirebaseSubcollectionCrudService<T extends AbstractSubDomain, U extends AbstractDomain,
        X extends AbstractFirebaseCrudService<U>>
    implements IFirebaseSubCrudService<T, U>, IFromJson<T> {
  final X rootService = di<X>();
...
///
abstract class AbstractFirebaseCrudService<T extends AbstractDomain>
